...
# Compile VText
$(VTEXT_OBJ): $(VTEXT_SRC) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c $(VTEXT_SRC) -o $(VTEXT_OBJ)
	@echo "VText compiled: $(VTEXT_OBJ)"

# Link kernel
$(KERNEL_BIN): $(KERNEL_ENTRY_OBJ) $(KERNEL_OBJ) $(PRINTF_OBJ) $(SCREEN_OBJ) $(KSCANF_OBJ) $(IDT_OBJ) $(IDT_ASM_OBJ) $(KEYBOARD_OBJ) $(VGA_OBJ) $(SHELL_OBJ) $(RAMFS_OBJ) $(VTEXT_OBJ) $(KERNEL_LINKER_SCRIPT) | $(BUILD_DIR)
	$(LD) -T $(KERNEL_LINKER_SCRIPT) $(KERNEL_ENTRY_OBJ) $(KERNEL_OBJ) $(PRINTF_OBJ) $(SCREEN_OBJ) $(KSCANF_OBJ) $(IDT_OBJ) $(IDT_ASM_OBJ) $(KEYBOARD_OBJ) $(VGA_OBJ) $(SHELL_OBJ) $(RAMFS_OBJ) $(VTEXT_OBJ) -o $(KERNEL_BIN)
